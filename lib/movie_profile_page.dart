...
import 'package:custom_sliver_app_bar/movie_profile_scroll_notification_handler.dart';
...
class MovieProfilePage extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final MovieProfileScrollNotificationHandler scrollNotificationHandler =
        MovieProfileScrollNotificationHandler(
